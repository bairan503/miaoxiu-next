...
const Contact = ({ onNavigate }) => {
  ...
  const contactInfo = [
    ...
    { icon: Phone, label: '电话', value: '+852 6213 4543' },
    { icon: Mail, label: '邮箱', value: 'contactmx@nvlx.cc' },
    { icon: Clock, label: '营业时间', value: '周一至周五 9:00-18:00 （节假日除外）' },
  ]
      ...
      <section className="relative min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90">我们期待与您的沟通与合作</p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-primary-50 rounded-xl">
                ...
                <p className="text-gray-500 text-sm mb-4">稍后上线，敬请期待</p>
              ...
              <div className="text-center p-6 bg-accent-50 rounded-xl">
                ...
                <p className="text-gray-500 text-sm mb-4">+852 6213 4543</p>
              ...
              <div className="text-center p-6 bg-yellow-50 rounded-xl">
                ...
                <p className="text-gray-500 text-sm mb-4">contactmx@nvlx.cc</p>
